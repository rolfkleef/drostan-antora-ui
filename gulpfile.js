...
const glob = {
  ...
  jslint: ['gulpfile.js', 'gulp.d/**/*.js', `${srcDir}/{helpers,js}/**/*.js`, `!${srcDir}/{helpers,js}/vendor/*.js`],
}
...
const previewBuildTask = createTask({
  ...
  call: parallel(series(buildTask), buildPreviewPagesTask),
})
