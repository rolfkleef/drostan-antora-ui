...
const compileSassTask = createTask({
  name: 'sass',
  desc: 'Compile the SASS source files into CSS',
  call: task.sass(glob.sass),
})
...
const bundleBuildTask = createTask({
  name: 'bundle:build',
  call: series(cleanTask, compileSassTask, lintTask, buildTask),
})
...
const previewBuildTask = createTask({
  ...
  call: parallel(series(compileSassTask, buildTask), buildPreviewPagesTask),
})

const previewServeTask = createTask({
  name: 'preview:serve',
  call: task.serve(previewDestDir, serverConfig, () => watch(glob.all, { queue: false }, previewBuildTask)),
})
