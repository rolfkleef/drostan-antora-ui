...
<style>
  ...
  main:has(#mode-light:checked) {
    color-scheme: light;
    background-color: var(--md-sys-color-background-light);
  }

  main:has(#mode-dark:checked) {
    color-scheme: dark;
  ...
  label {
    cursor: pointer;
    color: light-dark(var(--md-sys-color-on-background-light), var(--md-sys-color-on-background-dark));
  }
</style>

<form>
  select mode:
  <input type="radio" id="mode-light" name="mode" value="light" checked />
  <label for="mode-light" class="material-icons">light_mode</label>
  <input type="radio" id="mode-dark" name="mode" value="dark" />
  <label for="mode-dark" class="material-icons">dark_mode</label>
</form>
++++
...
<div class="styletable">
  ...
  <div>
    ...
    <div class="surface-dim">surface-dim</div>
    <div class="surface-bright">surface-bright</div>
  </div>
  <div></div>

  <div>
    <div class="surface-container-lowest">surface lowest</div>
  </div>
  <div>
    <div class="surface-container-low">surface low</div>
  </div>
  <div>
    <div class="surface-container">surface container</div>
  </div>
  <div>
    <div class="surface-container-high">surface high</div>
  </div>
  <div>
    <div class="surface-container-highest">surface highest</div>
  </div>
</div>
++++
