...
<div class="styletable">
  ...
  <div>
    ...
    <div class="surface-variant">variant</div>
  </div>
  <div></div>
...
=== With grid (no grid given) and stripes="even"

.Optional title
[cols="3*", options="footer", stripes="even"]
|===
