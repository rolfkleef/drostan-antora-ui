...
[NOTE]
====
This is a fork of {url-project}[the Antora default UI.]
The branch `drostan` contains my variation on the official default UI.

My own layout and CSS setup is deviating more and more from the official version.
I still track the upstream version to check for improvements made there.
====
